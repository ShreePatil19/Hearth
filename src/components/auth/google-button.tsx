...
function GoogleIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path
        fill="#FBBC05"
        d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18A10.998 10.998 0 0 0 1 12c0 1.77.42 3.45 1.18 4.93l2.85-2.22.81-.62Z"
      />
      <path
        fill="#EA4335"
...
export function GoogleButton({
  ...
  const handleClick = async () => {
    ...
    if (oauthError) {
      // Most common: Google provider not enabled in Supabase yet
